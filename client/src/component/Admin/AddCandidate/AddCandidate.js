...
export default class AddCandidate extends Component {
  ...
  addCandidate = async () => {
    await this.state.ElectionInstance.methods
      .addCandidate(this.state.header, this.state.slogan,this.state.party,this.state.place)
            ...
            <form className="form">
              ...
              <button
                ...
                disabled={
                  ...
                  ||this.state.party.length < 3 ||this.state.place.length < 3 
                }
...
export function loadAdded(candidates) {
  const renderAdded = (candidate) => {
    return (
      ...
      <tr>
        <td>{candidate.id}</td>
        <td><strong>{candidate.header}</strong></td>
